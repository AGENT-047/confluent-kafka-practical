...
kafka_config = {
    ...
    'sasl.username': '256FLSLKK47PPMWM',
    'sasl.password': 'cflti0RV7t0naDAiy0ajSuOAWj4xoekCpLlVozfMdcE2HZ3l1h3cZ5Di33cbLnww',
    'group.id': 'group1',
...
schema_registry_client = SchemaRegistryClient({
  ...
  'basic.auth.user.info': '{}:{}'.format('6C62S4GKQOKBZ3TJ', 'cflti241i8qDWQddOiTAa+G3ZQfiKwGJNX1FZiDK2x9fWUTqPifAVgFjR8U2wFZg')
})
